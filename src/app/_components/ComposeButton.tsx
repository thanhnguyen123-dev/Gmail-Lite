          ...
          {!isMinimized && (
            <div className="flex flex-col flex-grow w-full">
              <div className="flex items-center border-b border-gray-200 px-4 py-2 w-full">
                <label className="w-[15%] text-sm text-gray-600">To</label>
                <input 
                  type="text" 
                  value={to}
              ...
              <div className="flex items-center border-b border-gray-200 px-4 py-2 w-full">
                <label className="w-[15%] text-sm text-gray-600">Subject</label>
                <input 
                  type="text" 
                  value={subject}
              ...
              <textarea 
                ...
                className="flex-grow p-4 outline-none text-sm resize-none" 
              />
